...
.sv-root{
  ...
  background:#0C1126; min-height:100%; padding:0 0 28px;
}
...
.stage{display:flex; justify-content:center; padding:22px 14px}
...
.login-bg{background:linear-gradient(180deg,#F4F9FF, #EAF2FF 60%, #E4EEFF)}
